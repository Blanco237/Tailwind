      ...
      <div className="flex flex-col gap-4 justify-center items-center">
        ...
        <div className="content flex flex-row justify-start items-center mt-[2rem]">
          <section className="w-[50%] flex flex-col gap-24 px-32 py-7">
            <article className="text-gray-dark flex flex-col gap-4">
            <h4 className="font-medium text-4xl">Introducing an extensible editor</h4>
            ...
            <article className="text-gray-dark flex flex-col gap-4">
            <h4 className="font-medium text-4xl">Robust content management</h4>
            <p className="text-2xl font-normal">
