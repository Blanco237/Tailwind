  ...
  return (
    <li>
      <div className="relative">
        ...
        <div className={`${open? 'flex' : 'hidden'} flex-col rounded-md  gap-2 p-4 md:absolute bg-blue-100 text-black top-7 left-1 w-[9rem] shadow-lg`} onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)}>
